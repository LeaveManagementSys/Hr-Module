...
public class RetriveEmployeeModel {
	public RetriveEmployeeModel()
	{
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		RetriveEmployeeModel other = (RetriveEmployeeModel) obj;
		if (dateOfBirth == null) {
	...
	public String toString() {
		return "RetriveEmployeeModel [employeeId=" + employeeId + ", firstName=" + firstName + ", lastName=" + lastName
